...
namespace WindowsFormsApp4
{
    public partial class AddInput : Form
    {
        ...
        {
            toolTip1.SetToolTip(checkBox1, "Прибавления начисленны за период процентов к основной сумме вклада и последующее начисление дохода на сумму вклада и сумму прибавленных к нему процентов");
        }
    }
}
